...
else echo "Usage: cat <catalog.db> | $0 <authors|titles|dates|subjects|facets|languages|publishers>"; exit 1
fi

# parse out the requested data and do the work
cat /dev/stdin | sed '1d' - | cut -f1,$FIELD | $SCRIPT $1 > "$ETC/index-$1.idx"
